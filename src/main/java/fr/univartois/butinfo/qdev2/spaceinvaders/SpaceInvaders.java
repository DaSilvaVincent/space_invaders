...
import fr.univartois.butinfo.qdev2.spaceinvaders.model.SpaceInvadersFactory;
...
/**
 * La classe SpaceInvaders permet de lancer l'implantation en JavaFX du jeu
 * Space-Invaders.
 *
 ...
 * @version 0.1.0
 */
public final class SpaceInvaders extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("view/space-invaders.fxml"));
        ...
        SpaceInvadersGame game = new SpaceInvadersGame(
                GAME_WIDTH, GAME_HEIGHT, SpriteStore.getInstance(), new SpaceInvadersFactory());
